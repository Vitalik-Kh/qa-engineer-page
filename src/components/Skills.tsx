  ...
  const valuableSkills = useMemo(
    () => [
      ...
      },
      {
        id: "cursor",
        name: "Cursor",
        icon: <img src={CursorLogo} alt="Cursor logo" className="w-12 h-12" />,
      },
      {
        id: "bitbucket",
        name: "Bitbucket",
        icon: (
          <img src={BitbucketLogo} alt="Bitbucket logo" className="w-12 h-12" />
        ),
      },
      {
        id: "sql",
        name: "SQL",
        icon: <Database className="w-12 h-12" aria-label="SQL database icon" />,
      },
      {
        id: "aws",
        name: "AWS",
      ...
      },
      {
        ...
        name: "Postman",
        icon: (
          <img src={PostmanLogo} alt="Postman logo" className="w-12 h-12" />
        ),
      },
      {
        id: "git",
        name: "Git",
        icon: <img src={GitLogo} alt="Git logo" className="w-12 h-12" />,
      },
      {
        id: "docker",
        name: "Docker",
        icon: <img src={DockerLogo} alt="Docker logo" className="w-12 h-12" />,
      },
      {
        id: "jira",
        name: "Jira",
        icon: <img src={JiraLogo} alt="Jira logo" className="w-12 h-12" />,
      },
    ],
    []
  );
    ...
    <section id="skills" className="py-16 bg-white">
      <div className="section-padding">
        <div className="container-max-width">
          ...
          <div
            ref={sectionRef}
            className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-4 scroll-animate"
          >
